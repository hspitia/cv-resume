...
\geometry{left=2cm, top=2.0cm, right=2cm, bottom=2cm, footskip=.5cm} % Configure page margins with geometry
...
\makecvfooter{\today}{Hector F. Espitia-Navarro~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{sections/publications.cv.tex}
\input{sections/patent_applications.tex}
\input{sections/poster_presentations.cv.tex}
